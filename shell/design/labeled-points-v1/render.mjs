...
const server=createServer(async(req,res)=>{
 ...
 if(!['/','/index.html','/styles.css','/app.mjs','/title-points.mjs'].includes(name)){res.writeHead(404).end();return;}
...
const call=args=>new Promise((resolve,reject)=>{
 const p=spawn(process.execPath,[cli,'-s=dock-labeled-qa',...args],{windowsHide:true});let output='';
